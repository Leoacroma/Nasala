	...
	<div class="container-xl">
		<div class="position-relative mb-3">
			<div class="row g-3 justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0 font-dangrek-bold title-fonts" >ប្រភេទបណ្ណាល័យ</h1>
				</div>
				<a href="{{ route('admin.catelibrary.create') }}" class="btn btn-primary btn-add-style font-Hanuman-bold">បន្ថែមទិន្នន័យ</a>
			</div>
		</div>
...
<script type="text/javascript">
	...
	$(document).ready( function () {
    	var table = $('.myTable').DataTable({
			processing: true,
			serverSide: true,
			ajax : "{{ route('admin.catelibrary.Datatable') }}",
			columns: [
				{data: 'id', name: 'id'},
				{data: 'title_lib_cate_kh', name: 'title_lib_cate_kh'},
				{data: 'title_lib_cate_eng', name: 'title_lib_cate_eng'},
