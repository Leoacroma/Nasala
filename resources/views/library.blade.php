	...
	<div class="container-xl">
		<div class="position-relative mb-3">
			<div class="row g-3 justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0 font-dangrek-bold title-fonts" >បណ្ណាល័យ</h1>
				</div>
				<a href="{{ route('admin.library.create') }}" class="btn btn-primary btn-add-style font-Hanuman-bold">បន្ថែមទិន្នន័យ</a>
			</div>
		</div>
			...
			<div class="app-card-header px-4 py-3" style="padding: 20px">
				<table class="table myTable">
					<thead class="table caption-top">
                      ...
                      <td class="font-Hanuman-bold table-title-font" >File</td>
                      <td class="font-Hanuman-bold table-title-font" >ប្រភេទបណ្ណាល័យ</td>
...
<script type="text/javascript">
	...
	$(document).ready( function () {
    	var table = $('.myTable').DataTable({
			processing: true,
			serverSide: true,
			ajax : "{{ route('admin.library.Datatable') }}",
			columns: [
				{data: 'id', name: 'id'},
				{data: 'title_kh', name: 'title_kh'},
				{data: 'title_eng', name: 'title_eng'},
				{data: 'file', name: 'file'},
                {data: 'title_lib_cate_kh', name: 'cate_id'},
