	...
	<div class="container-xl">
		<div class="position-relative mb-3">
			<div class="row g-3 justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0 font-dangrek-bold title-fonts">ផែនការបណ្តុះបណ្តាល</h1>
				</div>
				<a href="{{ route('admin.tplan.create') }}" class="btn btn-primary btn-add-style font-Hanuman-bold">បន្ថែមទិន្នន័យ</a>
			</div>
		</div>
    	...
    	var table = $('.myTable').DataTable({
			processing: true,
			serverSide: true,
			ajax : "{{ route('admin.tplan.newsDatatable') }}",
			columns: [
				{data: 'id', name: 'id'},
