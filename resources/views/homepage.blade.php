...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        ...
        <h1 class="app-page-title font-dangrek-bold  title-fonts">ទំព័រដើម</h1>            
        <div class="row g-4 mb-4">
            <div class="col-6 col-lg-3">
                <div class="app-card app-card-stat shadow-sm h-100">
                    <div class="app-card-body p-3 p-lg-4">
                        <h4 class="stats-type mb-1 font-Hanuman-bold">ចំនួនព័ត៌មាន</h4>
                        <div class="stats-figure">
                            <?php $news =DB::table("news")->count();?>
                            <h5><?php print_r($news);?></h5>
...
<path fill-rule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z"/>
            ...
            <div class="col-6 col-lg-3">
                <div class="app-card app-card-stat shadow-sm h-100">
                    <div class="app-card-body p-3 p-lg-4">
                        <h4 class="stats-type mb-1 font-Hanuman-bold">បណ្ណាល័យ</h4>
                        <div class="stats-figure">
                            <?php $lib =DB::table('library')->count();?>
                            <h5><?php print_r($lib); ?></h5>
                        </div>
                        <div class="stats-meta text-success">
...
<path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z"/>
            ...
            <div class="col-6 col-lg-3">
                <div class="app-card app-card-stat shadow-sm h-100">
                    <div class="app-card-body p-3 p-lg-4">
                        <h4 class="stats-type mb-1 font-Hanuman-bold">វគ្គសិក្សា</h4>
                        <div class="stats-figure">
                            <?php $st = DB::table('enroll')->count();?>
                            <h5><?php print_r($st);?></h5>
                        </div>
            ...
            <div class="col-6 col-lg-3">
                <div class="app-card app-card-stat shadow-sm h-100">
                    <div class="app-card-body p-3 p-lg-4">
                        <h4 class="stats-type mb-1 font-Hanuman-bold">អាហារូបករណ៍</h4>
                        <div class="stats-figure">
                            <?php $scholar = DB::table('scholarship')->count();?>
                            <h5><?php print_r($scholar);?></h5>
                        </div>
                ...
                <div class="app-card app-card-chart h-100 shadow-sm">
                    <div class="app-card-header p-3">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-auto">
                                <h4 class="app-card-title font-dangrek-bold">ព័ត៌មានថ្មី</h4>
                            </div><!--//col-->
                        </div><!--//row-->
                    </div><!--//app-card-header-->
                        ...
                        <table class="table yajra-dt">
                            <table class="table">
                                <thead class="table caption-top">
                                    <td class="font-Hanuman-bold table-fonts" >ល.រ</td>
                                    <td class="font-Hanuman-bold table-fonts" >ចំណងជើងភាសាខ្មែរ</td>
                                    <td class="font-Hanuman-bold table-fonts">កាលបរិច្ឆេទ</td>
                                </thead>
                                <tbody>
                                   <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td >{{ Str::limit($table->title_kh, 40) }}</td>
